...
<body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <div class="pt-24">
        <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div class="w-full md:w-3/5 py-6 text-center">
                <img class="w-full md:w-4/5 z-50" src="template/Landing-Page-master/hero.png" />
            </div>
        </div>
    </div>
    ...
    <section class="bg-white border-b py-8">
        <div class="rounded-t-xl overflow-hidden bg-gradient-to-r from-emerald-50 to-teal-100 p-10">
            ...
            <table class="table-fixed text-black border-collapse">
                <thead>
                    <tr>
                        <th rowspan="2" class="border border-slate-300">Komponen Darah</th>
                        <th colspan="5" class="border border-slate-300">Golongan Darah</th>
                    </tr>
                    <tr>
                        <th class="border border-slate-300">A</th>
                        <th class="border border-slate-300">B</th>
                        <th class="border border-slate-300">O</th>
                        <th class="border border-slate-300">AB</th>
